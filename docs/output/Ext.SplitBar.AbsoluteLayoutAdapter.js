 ...
 */
Ext.data.JsonP.Ext_SplitBar_AbsoluteLayoutAdapter({
    "alternateClassNames": [],
    "aliases": {},
    "enum": null,
    "parentMixins": [],
    ...
    "superclasses": ["Ext.SplitBar.BasicLayoutAdapter"],
    "meta": {},
    "requires": [],
    "html_meta": {},
    "statics": {
        "property": [{
            "tagname": "property",
            "owner": "Ext.SplitBar.AbsoluteLayoutAdapter",
            "meta": {
                "static": true
            },
            "name": "BOTTOM",
            "id": "static-property-BOTTOM"
        }, {
            "tagname": "property",
            "owner": "Ext.SplitBar.AbsoluteLayoutAdapter",
            "meta": {
    ...
    "files": [{
        "href": "SplitBar.html#Ext-SplitBar-AbsoluteLayoutAdapter",
    ...
    "private": null,
    "component": false,
    "name": "Ext.SplitBar.AbsoluteLayoutAdapter",
    "singleton": false,
    "override": null,
    "inheritdoc": null,
    "id": "class-Ext.SplitBar.AbsoluteLayoutAdapter",
    "mixins": [],
    "mixedInto": []
});