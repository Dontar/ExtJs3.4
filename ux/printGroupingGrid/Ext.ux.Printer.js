...
Ext.override(Ext.ux.grid.CheckColumn, {
    renderer : function(v, p, record){
    	if (!p) {
    		if (v) {
    			return '<img src="images/checkbox_checked.png" width="16px" alt="ДА">';
    		} else {
    			return '<img src="images/checkbox_unchecked.png" width="16px" alt="НЕ">';
    		}
    	} else {
...
Ext.ux.Printer.BaseRenderer.prototype.stylesheetPath = 'res/ux/printGroupingGrid/Ext.ux.Printer.css';
